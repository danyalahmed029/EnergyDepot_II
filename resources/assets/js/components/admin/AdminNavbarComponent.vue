            ...
            <div class="container">
                ...
                <b-collapse is-nav id="nav_collapse">
                    <b-navbar-nav class="ml-auto">
                        <b-nav-item active-class="active" to="/adminOrders">Orders</b-nav-item>
                        <b-nav-item active-class="active" to="/adminUsers">Users</b-nav-item>
